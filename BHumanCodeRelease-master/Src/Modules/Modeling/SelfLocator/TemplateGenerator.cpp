...
void TemplateGenerator::init()
{
  ...
  Vector2f centerFor1(-3000.f,0.f);
  Vector2f centerFor2(-1000.f,0.f);
  Vector2f centerFor3(-1000.f,0.f);
  Vector2f centerFor4(-2000.f,0.f);
  Vector2f centerFor5(-2000.f,0.f);
    Vector2f pos1ToGoal = centerFor1 - pos1;
	Vector2f pos2ToGoal = centerFor2 - pos2;
	Vector2f pos3ToGoal = centerFor3 - pos3;
	Vector2f pos4ToGoal = centerFor4 - pos4;
	Vector2f pos5ToGoal = centerFor5 - pos5;

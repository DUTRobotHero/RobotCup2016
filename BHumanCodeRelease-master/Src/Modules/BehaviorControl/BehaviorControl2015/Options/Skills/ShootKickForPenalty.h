...
option(ShootKickForPenalty)
{
  initial_state(alignBehindBallInShootKick)
  {
    ...
    action
    {
        ...
        WalkToTarget(Pose2f(80.f, 80.f, 80.f), Pose2f(libCodeRelease.angleForPenaltyStriker, theBallModel.estimate.position.x() - 140.f, theBallModel.estimate.position.y() + 30.f));
    }
  }

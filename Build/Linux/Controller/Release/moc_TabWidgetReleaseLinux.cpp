...
#include "../../../../Src/Controller/Views/KickView/TabWidget.h"
...
static const char qt_meta_stringdata_TabBar[] = {
    "TabBar\0\0fromIndex,toIndex\0"
    "tabMoveRequested(int,int)\0"
};
...
void TabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->tabMoveRequested((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
